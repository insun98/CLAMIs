...
public static double getTopPercentileCutoff(Instances instances, String positiveLabel, HashMap<Double, Integer> percentileCorrelation){
		...
		*/
		...
		System.out.println("Top percentile: " + (double) percentileListArray[percentileListArray.length - 1]);
